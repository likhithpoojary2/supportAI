...
hover:bg-zinc-100" onClick={handleLogOut}
            ...
            <button
              className="px-5 py-2 bg-black text-white text-sm font-medium rounded-full hover:bg-zinc-800 transistion
      ...
      <section className="pt-36 pb-28 px-6">
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-20 items-center">
          ...
          >
            ...
            <p className="mt-6 text-lg text-zinc-600 max-w-x1">
              Add a powerful AI chatbot to your website in minutes. Let your
              customer gets instant answers using your own business knowledge
            </p>
